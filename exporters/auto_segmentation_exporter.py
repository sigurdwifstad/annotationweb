...
class AutoSegmentationExporterForm(forms.Form):
...
class AutoSegmentationExporter(Exporter):
    """
    asdads
    """

    task_type = Task.AUTO_SEGMENTATION
    name = 'Auto segmentation'

    def get_form(self, data=None):
        return AutoSegmentationExporterForm(self.task, data=data)
